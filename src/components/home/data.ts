export const services = [
  ...
  },
  {
    ...
    desc: "Creating cross-platform mobile apps with Flutter, focusing on smooth UI and native performance.",
  },
  {
    icon: "Paintbrush",
    title: "Figma to Code",
...
export const projects = [
  {
    id: "01",
    title: "Forum App",
    desc: "A modern forum application. Supports user authentication using automatic email verification by Resend",
  ...
  },
  {
    ...
    desc: "Manage taskes with drag-and-drop. Supports user authentication using automatic email verification by Resend",
    color: "from-blue-500/20 to-cyan-500/20",
  ...
  },
  {
    id: "03",
    title: "Coming Soon",
    desc: "An upcoming project showcasing advanced web technologies and innovative design.",
    color: "from-blue-500/20 to-cyan-500/20",
    tag: ["Next.js"],
    link: "#",
    image: "",
